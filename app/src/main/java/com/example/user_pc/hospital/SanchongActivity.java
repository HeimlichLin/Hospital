...
public class SanchongActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, NavigationView.OnNavigationItemSelectedListener, SearchView.OnQueryTextListener {
    ProgressDialog mDialog;
    ListView mListView,sListView;
    SanchongAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new SanchongAdapter(this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_paste_Hospital) {
            ...
            Intent BunqiaoIntent = new Intent(this, BunqiaoActivity.class);
            BunqiaoIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(BunqiaoIntent);
            overridePendingTransition(0, 0);
    ...
    private void loadData() {
        ...
        mAdapter = new SanchongAdapter(this);
        mListView.setAdapter(mAdapter);
        String urlString = "http://data.ntpc.gov.tw/api/v1/rest/datastore/382000000A-000016-002";
        ...
        client.get(urlString, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                for(int i=0; i<records.length(); i++){
                    ...
                    mSearchList.add(board.optString("publisher") + " " + "三重院區 候診資訊" + "\n"
